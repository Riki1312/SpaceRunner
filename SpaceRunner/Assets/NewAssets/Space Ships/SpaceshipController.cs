...
{
    [SerializeField] private RemoteControllers RemoteControllers_ref;
	...
	private void UpdateInput()
	{
		...
		switch (m_input.Mode)
		{
			case InputMode.Keyboard:
                ...
                currentRawInput.y = RemoteControllers_ref.AxisY * currentKeyboardSensitivity;
                break;
        ...
        currentRawInput.w = Input.GetAxis(m_input.Keyboard.InputNames.Throttle) * currentKeyboardSensitivity;
